...
function AlchemyAPI() {
	...
	try {
		key = process.env.VCAP_SERVICES ? JSON.parse(process.env.VCAP_SERVICES)["user-provided"][0].credentials.apikey : "bd7742494192d55f5c91e88b11b7790cd96b7f6e" //fs.readFileSync(__dirname + '/api_key.txt').toString().trim();
	}
	catch(err) {
		//Create the file
